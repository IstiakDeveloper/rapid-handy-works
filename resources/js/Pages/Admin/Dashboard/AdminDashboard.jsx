...
export default function AdminDashboard({
    ...
    const prepareBookingStatusData = () => {
        return Object.entries(bookingStatuses).map(
            ([status, count], index) => ({
                name:
    ...
    const prepareCategoryData = () => {
        return Object.entries(categoryDistribution).map(
    ...
    const prepareServiceStatusData = () => {
        return Object.entries(serviceStatusDistribution).map(
            ([status, count], index) => ({
    ...
    return (
        <div>
                ...
                >
                    ...
                    <div className="mt-4 text-sm">
                        <div className="flex items-center space-x-2">
                            ...
                            <span className="font-medium text-gray-900">
                                {serviceStatusDistribution.active}
                            </span>
                            <span className="text-gray-500 ml-3">
                                Inactive:
                            </span>
                            <span className="font-medium text-gray-900">
                                {serviceStatusDistribution.inactive}
                            </span>
                        </div>
                    </div>
                </motion.div>
                        ...
                        <div className="ml-3">
                            ...
                            <div className="mt-2 text-sm text-yellow-700">
                                <ul className="pl-5 space-y-1 list-disc">
                                    {issueCount.pending_payments > 0 && (
                                        <li>
                                            {issueCount.pending_payments}{" "}
                                            booking(s) with pending payments
                                            past their scheduled date
                                        </li>
                                    )}
                                    {issueCount.no_show_bookings > 0 && (
                                        <li>
                                            {issueCount.no_show_bookings}{" "}
                                            possible no-show booking(s) that
                                            need follow-up
                                        </li>
                                    )}
                                    {issueCount.low_rated_services > 0 && (
                                        <li>
                                            {issueCount.low_rated_services}{" "}
                                            service(s) with ratings below 3.0
                                            stars
                                        </li>
                                    )}
                                </ul>
            ...
            {/* Main Content Areas */}
            <div className="mt-6">
                {/* Overview Tab - Rest of the content here */}
                {activeTab === "overview" && (
                                                            ...
                                                            <img
                                                                ...
                                                                src={
                                                                    booking
                                                                        .client
                                                                        .avatar ||
                                                                    `https://ui-avatars.com/api/?name=${booking.client.name}&background=f59e0b&color=fff`
                                                                }
                                                                alt={
                                                                    booking
                                                                        .client
                        ...
                        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                            ...
                            >
                                <div className="px-6 py-5 border-b border-gray-200">
                                    ...
                                    <p className="mt-1 text-sm text-gray-500">
                                        Service providers with the most bookings
                                    </p>
                                </div>
                                <div className="overflow-x-auto">
                                    <table className="min-w-full divide-y divide-gray-200">
                                                        ...
                                                        <div className="flex items-center">
                                                            <div className="flex-shrink-0 w-8 h-8">
                                                                <img
                                                                    ...
                                                                    src={
                                                                        provider.avatar ||
                                                                        `https://ui-avatars.com/api/?name=${provider.name}&background=f59e0b&color=fff`
                                                                    }
                                                                    alt={
                                                                        provider.name
                                                                    }
                ...
                {/* Other tabs - Similar structure to what you already have */}
                {activeTab === "bookings" && (
                    <div className="p-8 mt-6 bg-white border border-gray-200 rounded-lg shadow-sm">
                        <div className="text-center">
                            ...
                            <p className="mt-2 text-gray-600">
                                Detailed view of the bookings dashboard is under
                                construction.
                            </p>
                            <p className="mt-4">
                                <a
                ...
                {activeTab === "services" && (
                    <div className="p-8 mt-6 bg-white border border-gray-200 rounded-lg shadow-sm">
                        <div className="text-center">
                            ...
                            <p className="mt-2 text-gray-600">
                                Detailed view of the services dashboard is under
                                construction.
                            </p>
                            <p className="mt-4">
                                <a
                ...
                {activeTab === "providers" && (
                    <div className="p-8 mt-6 bg-white border border-gray-200 rounded-lg shadow-sm">
                        <div className="text-center">
                            ...
                            <p className="mt-2 text-gray-600">
                                Detailed view of the providers dashboard is
                                under construction.
                            </p>
                            <p className="mt-4">
                                <a
                ...
                {activeTab === "analytics" && (
                    <div className="p-8 mt-6 bg-white border border-gray-200 rounded-lg shadow-sm">
                        <div className="text-center">
                            ...
                            <p className="mt-2 text-gray-600">
                                Detailed analytics dashboard is under
                                construction.
                            </p>
                            <p className="mt-4">
                                <a
